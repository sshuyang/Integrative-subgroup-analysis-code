function [BIC_gamma2] = BIC_gaus_MCP_gamma2( X,Y,Z,gamma,gamma1,gamma2_list,beta10,beta20,c)
%%% Calculate BIC for gamma2
...
[theta1,theta2,beta1,beta2,Z_output,~] = isa_gaus_MCP_ADMM(X,Y,Z,gamma,gamma1,gamma2_list(i),beta10,beta20);
...
BIC_gamma2(i) = alpha_X * log(data_fidelity1/n) + alpha_Y * log(data_fidelity2/n) + Cn * log(n) * (2*no_class+p1+p2)/(n);
end
