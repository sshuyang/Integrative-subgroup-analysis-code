function [BIC_gamma1] = BIC_gauslogit_MCP_gamma1( X,Y,Z,gamma,gamma1_list,gamma2,beta10,beta20,c)
...
[theta1,theta2,beta1,beta2,Z_output,~] = isa_gauslogit_MCP_ADMM(X,Y,Z,gamma,gamma1_list(i),gamma2,beta10,beta20,rho);
...
BIC_gamma1(i) = alpha_X * log(data_fidelity1/n) + 2 * alpha_Y * data_fidelity2/n + Cn * log(n) * (2*no_class+p1+p2)/n;
end
